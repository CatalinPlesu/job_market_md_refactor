...
def main():
    ...
    try:
        ...
        logger.info("Starting Rabota.md scraping")
        ...
        if is_within_processing_window():
            logger.info("Current time is within the UTC range 16:30 - 00:30. Processing data...")
            ...
            logger.info("Current time in Moldova is outside the UTC range. Skipping processing.")

    except Exception as e:
        logger.error(f"An error occurred during job scraping: {e}", exc_info=True)
